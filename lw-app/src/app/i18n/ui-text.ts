...
export const uiText = {
  en: {
    ...
    cards: {
      ...
      searchEmptyIntro: 'Try another word or translation. You can still add a new card below.',
      perPage: 'Per page',
  ...
  ru: {
    ...
    cards: {
      ...
      searchEmptyIntro: 'Попробуйте другое слово или перевод. Новую карточку можно добавить ниже.',
      perPage: 'На странице',
